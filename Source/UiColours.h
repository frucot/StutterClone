...
namespace UiColours
{
    const juce::Colour background { 0xff101218 };
    const juce::Colour panel      { 0xff1b1f2b };
    const juce::Colour accent     { 0xff6ee7ff };
    const juce::Colour keyHeld    { 0xffff8a3c };
    const juce::Colour inactive   { 0xffff6b7d };
